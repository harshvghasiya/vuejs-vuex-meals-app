	...
	<div class="signup-form">
	    <form action="" method="post">
	        ...
	        <div class="form-group">
				<input type="text" class="form-control" v-model="name" name="name" placeholder="First Name" >
	        </div>
	        <div class="form-group">
			...
			<div class="form-group">
	            <button type="button" v-on:click="signUp" class="btn btn-success btn-lg btn-block">Register Now</button>
	        </div>
	    </form>
